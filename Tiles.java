...
public class Tiles {
    ...
    public static Tiles[] getAllTiles() {
        ...
        tiles[6] = new PropertyField(6, "Jail 6", 2, 3);//CHANGE THIS
        ...
        tiles[12] = new PropertyField(12, "Free Parking 12", 2, 3);//CHANGE THIS
        ...
        tiles[18] = new PropertyField(18, "Go to jail 18", 2, 3);//CHANGE THIS
